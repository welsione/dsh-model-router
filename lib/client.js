          ...
          Object.keys(routes).length === 0
            ...
            : Object.keys(routes).sort().map(function (id) {
                ...
                return React.createElement('div', { className: 'dsh-mr-route', key: id },
                  ...
                  // 套餐级档位名称：每个套餐单独设置三档显示名（点击胶囊就地编辑，清空恢复默认）
                  React.createElement('div', { className: 'dsh-mr-subsec', title: '该套餐三档的显示名（对话窗口与设置面板展示），点击胶囊编辑，清空恢复默认' },
                    ...
                    TIER_ORDER2.map(function (slot) {
                      ...
                      return React.createElement(TierNamePill, { key: slot, rid: id, slot: slot, dflt: dflt,
