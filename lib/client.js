      ...
      return React.createElement('div', { className: 'dsh-mr' },
        ...
        card('cooldowns', t('cd.title'),
          cooldownList.length > 0
            ? React.createElement('span', { className: 'dsh-mr-count-badge' }, cooldownList.length)
        ...
        card('global', t('global.title'),
          ...
          [
            ...
            React.createElement('div', { className: 'dsh-mr-actions', key: 'act' },
