  ...
  factory: (require) => {
          ...
          chain.length === 0
            ...
            : chain.map(function (c, i) {
                ...
                return React.createElement('div', { className: 'dsh-mr-cand', key: i },
                  ...
                  React.createElement('select', {
                    className: 'dsh-mr-sel dsh-mr-sel-effort', 'aria-label': '思考级别', title: '思考级别',
    ...
    function apply(ctx) {
      ...
      styleEl.textContent = [
        ...
        '.dsh-mr-hstat { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; font-size: 10px; font-weight: 600; color: var(--dsw-alias-state-success-primary, #34c759); white-space: nowrap; flex: none; }',
